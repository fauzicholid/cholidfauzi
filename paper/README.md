...
`JISEBI_West_Java_Landcover.docx` — "A Validated Workflow for Comparing
Markov-Chain and Deep-Learning Models in Spatiotemporal Change Prediction
from Satellite Imagery," formatted for submission to JISEBI (Journal of
